...
Also, it is easy to show the following inequality.\footnote{The same lower bound is proven in \cite{WillemsST95} with $-\ln(2)$ instead of $- \ln(e \pi \sqrt{2})$ on the lhs, but only for $a,b$ integers.}
\begin{lemma}
