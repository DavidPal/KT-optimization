...
\begin{proof}[Proof of Theorem~\ref{theo:hilbert_reward}]
  ...
  &\geq \min_{r\in \{-1,1\}} \left(1+ r\, b_n \right) f_{n-1}\left( \norm{\theta_{n-1}}\right) - f_n\left(\left| \norm{\theta_{n-1}} + r\right|\right)\\
  &= \min_{r\in \{-1,1\}} \left(1+ r\, b_n \right) f_{n-1}\left( \norm{\theta_{n-1}}\right) - f_n\left( \norm{\theta_{n-1}} + r \right)\\
  &\geq 0,
  \end{align*}
...
For the third assumption we have to verify that
\[
(1+\frac{x_{t-1}}{t} z) \frac{2^{t-1} \cdot \Gamma \left(\frac{t}{2} + \frac{x_{t-1}}{2} \right) \cdot \Gamma \left(\frac{t}{2} - \frac{x_{t-1}}{2} \right)}{\pi \cdot (t-1)!}
\geq \frac{2^t \cdot \Gamma \left(\frac{t+1}{2} + \frac{x_{t-1}+z_t}{2} \right) \cdot \Gamma \left(\frac{t+1}{2} - \frac{x_{t-1}+z}{2} \right)}{\pi \cdot t!} \;.
\]
We will actually prove it with an equality.
Consider the case that $z_t=1$. We have
\begin{align*}
\frac{2^t \cdot \Gamma \left(\frac{t+1}{2} + \frac{x_{t-1}+z_t}{2} \right) \cdot \Gamma \left(\frac{t+1}{2} - \frac{x_{t-1}+z}{2} \right)}{\pi \cdot t!}
